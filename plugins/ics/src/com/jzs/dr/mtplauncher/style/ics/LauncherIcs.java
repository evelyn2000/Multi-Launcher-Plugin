...
import com.jzs.dr.mtplauncher.style.ics.widget.AppsCustomizePagedViewDefault;
import com.jzs.dr.mtplauncher.style.ics.widget.AppsCustomizeTabHost;
import com.jzs.dr.mtplauncher.style.ics.widget.WorkspaceDefault;
//import com.jzs.dr.mtplauncher.widget.Workspace;
//import com.jzs.dr.mtplauncher.sjar.exthelpers.LauncherHelper;
import com.android.common.Search;


public class LauncherIcs extends Launcher {

	private static final int MENU_GROUP_WALLPAPER = MENU_CHILD_GROUP_ID + 1;
    //private static final int MENU_WALLPAPER_SETTINGS = MENU_CHILD_ID + 1;
 ...
 // How long to wait before the new-shortcut animation automatically pans the workspace
    ...
    private AppsCustomizePagedViewDefault mAppsCustomizeContent;
 ...
 // External icons saved in case of resource changes, orientation, etc.
    ...
    public LauncherIcs(Context localContext){
		this(localContext, null);
	}
    
    public LauncherIcs(Context localContext, ILauncherApplication mainApp){
	...
	protected IResConfigManager createResConfigManager(ISharedPrefSettingsManager pref, IResConfigManager base){
	    ...
	    //return ResConfigManagerIcs.getInstance(this, pref, base);
	}
	
//	protected IExtHelperBase createExtHelper(String target){
////		if(ILauncherPluginEntry.EXT_HELPER_TARGET_LAUNCHER.equals(target)){
////			return new LauncherDefault(getLocalContext());
////		}
//
//		return null;
//	}
...
//        mBlackBackgroundDrawable = new ColorDrawable(Color.BLACK);
     ...
     // Get the search/delete bar
        ...
        mAppsCustomizeContent = (AppsCustomizePagedViewDefault)
...
//    }
    ...
    public boolean onLongClick(View v) {
        if (Util.ENABLE_DEBUG) {
        	Util.Log.d(TAG, "onLongClick: View = " + v + ", v.getTag() = " + v.getTag()
                    + ", mState = " + mState);
        }
    ...
    protected void hideAppsCustomizeHelper(int toState, final boolean animated,
        ...
        if (Util.ENABLE_DEBUG) {
        	Util.Log.d(TAG, "hideAppsCustomzieHelper toState = " + toState + ", animated = " + animated
    ...
    private void runNewAppsAnimation(boolean immediate) {
        ...
        Collections.sort(mNewShortcutAnimateViews, new Comparator<View>() {
            ...
            public int compare(View a, View b) {
                ...
                int cellCountX = getWorkspaceCellCountX();
