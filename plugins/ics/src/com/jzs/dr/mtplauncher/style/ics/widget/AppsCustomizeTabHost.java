...
public class AppsCustomizeTabHost extends TabHost implements IAppsCustomizePanel,
    ...
    private AppsCustomizePagedViewDefault mAppsCustomizePane;
     ...
     * tabs manually).
     */
    public void setContentTypeImmediate(AppsCustomizePagedViewDefault.ContentType type) {
    ...
    public void selectAppsTab() {
        ...
        setContentTypeImmediate(AppsCustomizePagedViewDefault.ContentType.Applications);
    }
    ...
    public void selectWidgetsTab() {
        ...
        setContentTypeImmediate(AppsCustomizePagedViewDefault.ContentType.Widgets);
    }
    ...
    protected void onFinishInflate() {
        ...
        final AppsCustomizePagedViewDefault appsCustomizePane = (AppsCustomizePagedViewDefault)
    ...
    private void onTabChangedEnd(AppsCustomizePagedViewDefault.ContentType type) {
        mAppsCustomizePane.setContentType(type);
    }

    @Override
    public void onTabChanged(String tabId) {
        final AppsCustomizePagedViewDefault.ContentType type = getContentTypeForTabTag(tabId);
        if (Util.ENABLE_DEBUG) {
        ...
        post(new Runnable() {
            ...
            public void run() {
                ...
                for (int i = visiblePages.size() - 1; i >= 0; i--) {
                    ...
                    if (Util.ENABLE_DEBUG) {
                        Util.Log.d(TAG, "onTabChanged before remove view: i = " + i
    ...
    public void setCurrentTabFromContent(AppsCustomizePagedViewDefault.ContentType type) {
        setOnTabChangedListener(null);
        setCurrentTabByTag(getTabTagForContentType(type));
        setOnTabChangedListener(this);
    }
     ...
     */
    public AppsCustomizePagedViewDefault.ContentType getContentTypeForTabTag(String tag) {
        if (tag.equals(APPS_TAB_TAG)) {
            return AppsCustomizePagedViewDefault.ContentType.Applications;
        } else if (tag.equals(WIDGETS_TAB_TAG)) {
            return AppsCustomizePagedViewDefault.ContentType.Widgets;
        }
        return AppsCustomizePagedViewDefault.ContentType.Applications;
    }
     ...
     */
    public String getTabTagForContentType(AppsCustomizePagedViewDefault.ContentType type) {
        if (type == AppsCustomizePagedViewDefault.ContentType.Applications) {
            return APPS_TAB_TAG;
        } else if (type == AppsCustomizePagedViewDefault.ContentType.Widgets) {
    ...
    public void onLauncherTransitionStart(Launcher l, boolean animated, boolean toWorkspace) {
        if (Util.ENABLE_DEBUG) {
            Util.Log.d(TAG, "onLauncherTransitionStart: l = " + l + ", animated = " + animated + ", toWorkspace = "
                    + toWorkspace);
        }
