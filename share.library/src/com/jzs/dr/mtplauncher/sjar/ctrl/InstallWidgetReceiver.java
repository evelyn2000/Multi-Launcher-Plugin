...
public class InstallWidgetReceiver {
    ...
    public static class WidgetListAdapter implements ListAdapter, DialogInterface.OnClickListener {
        ...
        private String mDropWidgetPickFormat;
        ...
        public WidgetListAdapter(Launcher l, String mimeType, ClipData data,
            ...
            mLayoutResId = res.getResourceId(IResConfigManager.LAYOUT_INSTALL_WIDGET_ADAPTER);
            mDropWidgetPickFormat = res.getString(IResConfigManager.STR_INSTALL_WIDGET_PICK_FORMAT);
            //R.string.external_drop_widget_pick_format
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = mInflater.inflate(mLayoutResId/*R.layout.external_widget_drop_list_item*/, parent,
                        false);
            }
            ...
            ImageView i = (ImageView) convertView.findViewWithTag("provider_icon");//.findViewById(R.id.provider_icon);
            ...
            TextView t = (TextView) convertView.findViewWithTag("provider");//.findViewById(R.id.provider);
            if(!TextUtils.isEmpty(mDropWidgetPickFormat)){
	            t.setText(String.format(mDropWidgetPickFormat/*context.getString(R.string.external_drop_widget_pick_format*/,
