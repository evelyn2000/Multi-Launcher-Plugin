...
import com.jzs.dr.mtplauncher.sjar.widget.AccessibleTabView;
import com.jzs.dr.mtplauncher.sjar.widget.BubbleTextView;
import com.jzs.dr.mtplauncher.sjar.widget.CellLayout;
import com.jzs.dr.mtplauncher.sjar.widget.FocusOnlyTabWidget;
...
public class FocusHelper {
	protected static final String TAG = "FocusHelper";
    /**
     * Private helper to get the parent TabHost in the view hiearchy.
     */
    protected static TabHost findTabHostParent(View v) {
    ...
    public static boolean handleTabKeyEvent(AccessibleTabView v, int keyCode, KeyEvent e) {
        if (!Launcher.isScreenLarge()) return false;
        ...
        if (Util.DEBUG_KEY) {
        	Util.Log.d(TAG, "handleTabKeyEvent: action = " + action + ", tabCount = " + tabCount
    ...
    public static boolean handleHotseatButtonKeyEvent(View v, int keyCode, KeyEvent e, int orientation) {
        if (Util.DEBUG_KEY) {
        	Util.Log.d(TAG, "handleHotseatButtonKeyEvent: v = " + v + ", tag = " + v.getTag()
                    + ", event = " + e + ", orientation = " + orientation);
        }

        final ViewGroup parent = (ViewGroup) v.getParent();
        final ViewGroup launcher = (ViewGroup) parent.getParent();
        final Workspace workspace = (Workspace) launcher.findViewWithTag("workspace");//.findViewById(R.id.workspace);
     ...
     */
    protected static ShortcutAndWidgetContainer getCellLayoutChildrenForIndex(
    ...
    public static boolean handleIconKeyEvent(View v, int keyCode, KeyEvent e) {
        if (Util.DEBUG_KEY) {
        	Util.Log.d(TAG, "handleIconKeyEvent: v = " + v + ", tag = " + v.getTag()
                    + ", event = " + e);
        }
    ...
    public static boolean handleFolderKeyEvent(View v, int keyCode, KeyEvent e) {
        if (Util.DEBUG_KEY) {
        	Util.Log.d(TAG, "handleFolderKeyEvent: v = " + v + ", event = " + e);
        }

        ShortcutAndWidgetContainer parent = (ShortcutAndWidgetContainer) v.getParent();
        final CellLayout layout = (CellLayout) parent.getParent();
        final Folder folder = (Folder) layout.getParent();
        View title = folder.getEditTextRegion();
     ...
     */
    public static boolean handlePagedViewGridLayoutWidgetKeyEvent(PagedViewWidget w, int keyCode,
            KeyEvent e) {
    	if (Util.DEBUG_KEY) {
    		Util.Log.d(TAG, "handlePagedViewGridLayoutWidgetKeyEvent: w = " + w 
    ...
    public static boolean handleAppsCustomizeKeyEvent(View v, int keyCode, KeyEvent e) {
        ...
        int countY;
        if (Util.DEBUG_KEY) {
        	Util.Log.d(TAG, "handleAppsCustomizeKeyEvent: v = " + v + ", keyCode = " + keyCode
                    + ", event = " + e + ", parent = " + v.getParent());
        }

        /// M: added for unread feature, the icon is placed in a RealtiveLayout.
        if (v.getParent() instanceof MtpAppIconView) {
            v = (View)v.getParent();
        }
