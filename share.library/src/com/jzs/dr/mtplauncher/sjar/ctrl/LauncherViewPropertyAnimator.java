...
public class LauncherViewPropertyAnimator extends Animator implements AnimatorListener {
    private final static String TAG = "PropertyAnimator";
    ...
    public EnumSet<Properties> mPropertiesToSet = EnumSet.noneOf(Properties.class);
    ...
    public void onAnimationCancel(Animator animation) {
        if (Util.DEBUG_ANIM) {
            Util.Log.d(TAG, "onAnimationCancel() = "+this);
        }
    ...
    public void onAnimationEnd(Animator animation) {
        if (Util.DEBUG_ANIM) {
            Util.Log.d(TAG, "onAnimationEnd() = "+this);
        }
        for (int i = 0; i < mListeners.size(); i++) {
            Animator.AnimatorListener listener = mListeners.get(i);
    ...
    public void onAnimationRepeat(Animator animation) {
        if (Util.DEBUG_ANIM) {
            Util.Log.d(TAG, "onAnimationRepeat() = "+this);
        }
        for (int i = 0; i < mListeners.size(); i++) {
            Animator.AnimatorListener listener = mListeners.get(i);
    ...
    public void onAnimationStart(Animator animation) {
        if (Util.DEBUG_ANIM) {
            Util.Log.d(TAG, "onAnimationStart() = "+this);
        }
        for (int i = 0; i < mListeners.size(); i++) {
            Animator.AnimatorListener listener = mListeners.get(i);
