...
public interface DropTarget {
    ...
    public class DragObject {
        ...
        public String toString() {
            return "DragObject(cancelled=" + cancelled 
                    + ", dragComplete="+dragComplete
                    + ", x="+x
                    + ", y="+y
                    + ", xOffset="+xOffset
                    + ", yOffset="+yOffset
                    + ", Animation="+deferDragViewCleanupPostAnimation
                    + ", dragView="+dragView+")";
        }
    }

    public static class DragEnforcer implements DragController.DragListener {
        public int dragParity = 0;
        ...
        public void onDragEnter() {
            dragParity++;
            if (dragParity != 1) {
            	Util.Log.e(TAG, "onDragEnter: Drag contract violated: " + dragParity);
            }
        }
        ...
        public void onDragExit() {
            dragParity--;
            if (dragParity != 0) {
            	Util.Log.e(TAG, "onDragExit: Drag contract violated: " + dragParity);
            }
        }
