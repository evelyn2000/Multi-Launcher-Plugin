...
public abstract class SmoothPagedView extends PagedView {
    protected static final float SMOOTHING_SPEED = 0.75f;
    protected static final float SMOOTHING_CONSTANT = (float) (0.016 / Math.log(SMOOTHING_SPEED));

    protected float mBaseLineFlingVelocity;
    protected float mFlingVelocityInfluence;

    public static final int DEFAULT_MODE = 0;
    public static final int X_LARGE_MODE = 1;
    ...
    protected void snapToPageWithVelocity(int whichPage, int velocity, boolean settle) {
