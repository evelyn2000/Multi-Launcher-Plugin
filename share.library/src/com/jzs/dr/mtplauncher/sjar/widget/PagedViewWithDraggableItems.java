...
public abstract class PagedViewWithDraggableItems extends PagedView
    ...
    protected View mLastTouchedItem;
    protected boolean mIsDragging;
    protected boolean mIsDragEnabled;
    protected float mDragSlopeThreshold;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        if (Util.DEBUG_MOTION) {
            Util.Log.d(TAG, "onInterceptTouchEvent: ev = " + ev + ", mTouchState = "
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        if (Util.DEBUG_MOTION) {
            Util.Log.d(TAG, "onTouchEvent ev = " + ev + ",mTouchState = " + mTouchState
    ...
    public boolean onTouch(View v, MotionEvent event) {
    	if (Util.DEBUG_MOTION) {
    	    Util.Log.d(TAG, "onTouch: v = " + v + ", event = " + event + ",this = " + this);
    	}
    ...
    public boolean onLongClick(View v) {
        if (Util.ENABLE_DEBUG) {
            Util.Log.d(TAG, "onLongClick v = " + v + ", v.getTag() = " + v.getTag()
