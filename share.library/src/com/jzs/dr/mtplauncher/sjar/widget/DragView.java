...
public class DragView extends View {
    ...
    public DragView(Launcher launcher, Bitmap bitmap, int registrationX, int registrationY,
        ...
        final float offsetX = resManager.getDimensionPixelSize(IResConfigManager.DIM_DRAG_VIEW_OFFSETX);//.getDragViewOffsetX();//res.getDimensionPixelSize(R.dimen.dragViewOffsetX);
        final float offsetY = resManager.getDimensionPixelSize(IResConfigManager.DIM_DRAG_VIEW_OFFSETY);//res.getDimensionPixelSize(R.dimen.dragViewOffsetY);
        final float scaleDps = resManager.getDimensionPixelSize(IResConfigManager.DIM_DRAG_VIEW_SCALE);//res.getDimensionPixelSize(R.dimen.dragViewScale);
        ...
        if (Util.ENABLE_DEBUG) {
            Util.Log.d(TAG, "DragView constructor: mRegistrationX = " + mRegistrationX
    ...
    public void show(int touchX, int touchY) {
        ...
        if (Util.ENABLE_DEBUG) {
            Util.Log.d(TAG, "show DragView: x = " + lp.x + ", y = " + lp.y + ", width = " + lp.width
    ...
    public void remove() {
        if (Util.ENABLE_DEBUG) {
            Util.Log.d(TAG, "remove DragView: this = " + this);
        }
