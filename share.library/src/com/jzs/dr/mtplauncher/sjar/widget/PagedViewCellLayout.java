...
public class PagedViewCellLayout extends ViewGroup implements Page {
    protected static final String TAG = "PagedViewCellLayout";
    ...
    protected int mOriginalPaddingLeft;
    protected int mOriginalPaddingRight;
    ...
    public PagedViewCellLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PagedViewCellLayout, defStyle, 0);
        mOriginalCellWidth = mCellWidth = a.getDimensionPixelSize(R.styleable.PagedViewCellLayout_cellWidth, -1);
             //   a.getDimensionPixelSize(R.dimen.apps_customize_cell_width);
        mOriginalCellHeight = mCellHeight = a.getDimensionPixelSize(R.styleable.PagedViewCellLayout_cellHeight, -1);
          //  a.getDimensionPixelSize(R.dimen.apps_customize_cell_height);
        mWidthGap = mOriginalWidthGap = a.getDimensionPixelSize(R.styleable.PagedViewCellLayout_widthGap, -1);
        mHeightGap = mOriginalHeightGap = a.getDimensionPixelSize(R.styleable.PagedViewCellLayout_heightGap, -1);
        mMaxGap = a.getDimensionPixelSize(R.styleable.PagedViewCellLayout_maxGap, 18);
        a.recycle();
...
//            resources.getDimensionPixelSize(R.dimen.apps_customize_cell_height);
        ...
        mCellCountX = 4;//LauncherModel.getCellCountX();
        mCellCountY = 4;//LauncherModel.getCellCountY();
...
//        mMaxGap = resources.getDimensionPixelSize(R.dimen.apps_customize_max_gap);
    ...
    public void destroyHardwareLayers() {
        if (Util.DEBUG_DRAW) {
        	Util.Log.d(TAG, "destroyHardwareLayers: mChildren = " + mChildren + " ,this = " + this);
        }
    ...
    public void createHardwareLayers() {
        if (Util.DEBUG_DRAW) {
        	Util.Log.d(TAG, "createHardwareLayers: mChildren = " + mChildren + ", this = " + this);
        }
    ...
    public void removeAllViewsOnPage() {
        if (Util.ENABLE_DEBUG) {
        	Util.Log.d(TAG, "removeAllViewsOnPage: mChildren = " + mChildren + ", this = " + this);
        }
    ...
    public void removeViewOnPageAt(int index) {
        if (Util.ENABLE_DEBUG) {
        	Util.Log.d(TAG, "removeViewOnPageAt: mChildren = " + mChildren + ", index = " + index);
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mOriginalWidthGap < 0 || mOriginalHeightGap < 0) {
            ...
            if (Util.DEBUG_LAYOUT) {
            	Util.Log.d(TAG, "onMeasure 0: mMaxGap = " + mMaxGap + ", numWidthGaps = "
        ...
        if (Util.DEBUG_LAYOUT) {
        	Util.Log.d(TAG, "onMeasure 1: newWidth = " + newWidth + ", newHeight = " + newHeight
        ...
        if (widthSpecMode == MeasureSpec.AT_MOST) {
            ...
            if (Util.DEBUG_LAYOUT) {
            	Util.Log.d(TAG, "onMeasure 2: newWidth = " + newWidth + ", newHeight = "
                        + newHeight + ", this = " + this);
            }
        ...
        if (Util.DEBUG_LAYOUT) {
        	Util.Log.d(TAG, "onMeasure 4: newWidth = " + newWidth + ", newHeight = " + newHeight
                    + ", this = " + this);
        }
    ...
    public int[] getCellCountForDimensions(int width, int height) {
        ...
        if (Util.DEBUG_LAYOUT) {
        	Util.Log.d(TAG, "getCellCountForDimensions width = " + width + ", height =" + height + ", spanX = " + spanX
    ...
    public int estimateCellHSpan(int width) {
        ...
        if (Util.DEBUG_LAYOUT) {
        	Util.Log.d(TAG, "estimateCellHSpan width = " + width
    ...
    public int estimateCellVSpan(int height) {
        ...
        if (Util.DEBUG_LAYOUT) {
        	Util.Log.d(TAG, "estimateCellVSpan width = " + height
    ...
    public int[] estimateCellPosition(int x, int y) {
        ...
        if (Util.DEBUG_LAYOUT) {
        	Util.Log.d(TAG, "estimateCellPosition x = " + x + ", y = " + y
    ...
    public void calculateCellCount(int width, int height, int maxCellCountX, int maxCellCountY) {
        ...
        if (Util.DEBUG_LAYOUT) {
        	Util.Log.d(TAG, "calculateCellCount width = " + width
    ...
    public int estimateCellWidth(int hSpan) {
        if (Util.DEBUG_LAYOUT) {
        	Util.Log.d(TAG, "estimeateCellWidth hSpan = " + hSpan
    ...
    public int estimateCellHeight(int vSpan) {
        if (Util.DEBUG_LAYOUT) {
        	Util.Log.d(TAG, "estimateCellHeight sSpan = " + vSpan
