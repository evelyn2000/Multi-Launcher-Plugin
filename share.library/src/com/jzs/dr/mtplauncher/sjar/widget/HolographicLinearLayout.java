...
import com.jzs.dr.mtplauncher.sjar.ctrl.HolographicViewHelper;
...
public class HolographicLinearLayout extends LinearLayout {
    ...
    public HolographicLinearLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        highlightColor = a.getColor(R.styleable.HolographicLinearLayout_highlightColor, 
        			context.getResources().getColor(android.R.color.holo_blue_light));
        a.recycle();

        setWillNotDraw(false);
        mHolographicHelper = new HolographicViewHelper(context, highlightColor);
    }
