...
public class PagedViewGridLayout extends GridLayout implements Page {
    ...
    public void destroyHardwareLayer() {
        if (Util.DEBUG_DRAW) {
        	Util.Log.d(TAG, "destroyHardwareLayer: this = " + this);
        }
    ...
    public void createHardwareLayer() {
        if (Util.DEBUG_DRAW) {
        	Util.Log.d(TAG, "cretaeHardwareLayer: this = " + this);
        }
    ...
    public void removeAllViewsOnPage() {
        if (Util.DEBUG_DRAW) {
        	Util.Log.d(TAG, "removeAllViewsOnPage: this = " + this);
        }
        removeAllViews();
        mOnLayoutListener = null;
    ...
    public void removeViewOnPageAt(int index) {
        if (Util.DEBUG_DRAW) {
        	Util.Log.d(TAG, "removeViewOnPageAt: index = " + index);
        }
        removeViewAt(index);
    }
