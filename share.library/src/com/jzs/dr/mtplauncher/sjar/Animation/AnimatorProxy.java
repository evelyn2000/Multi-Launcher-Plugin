package com.jzs.dr.mtplauncher.sjar.Animation;
...
public final class AnimatorProxy extends Animation  {
    public static final boolean NEEDS_PROXY = false;//Integer.valueOf(Build.VERSION.SDK).intValue() < Build.VERSION_CODES.HONEYCOMB;
